                    ...
                    <form action="{{ route('events.update',$event->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="shadow rounded-lg overflow-hidden">
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 text-xs font-small text-gray-500">
                                <a href="{{ route('events.index') }}">Event List</a> > <b>Update Event Information</b>
                            </div>
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="flex flex-row flex-wrap md:flex-nowrap">
                                    <div class="w-full md:w-1/2 md:mr-4 my-2">
                                        ...
                                        <input type="text" name="name" id="name" autocomplete="name" value="{{ $event->name }}" class="mt-2 w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                                    ...
                                    <div class="w-full md:w-1/2 md:ml-4 my-2">
                                        ...
                                        <input type="text" name="slug" id="slug" autocomplete="slug" value="{{ $event->slug }}" class="mt-2 w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm">
